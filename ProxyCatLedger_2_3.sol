...
contract ProxycatLedger{ 
    ...
    string public version="2.3";
   
    constructor()public {master=msg.sender;}
    
    function addCall(address kitty,string memory family,string memory label,string memory abi) public returns(bool){
    ...
    function editCall(address kitty,string memory family,string memory label,string memory abi) public returns(bool){
